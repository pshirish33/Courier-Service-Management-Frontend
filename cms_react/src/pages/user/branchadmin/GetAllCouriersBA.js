...
function GetAllCouriersBA() {
    ...
    const fetchdata = () => {
        ...
        axios.get(config.serverURL + `/branchadmin/getallcouriers/${branchId}`)
            .then((response) => {
    ...
    return (<>
        ...
        <div className="container">
            ...
            <div>
                <button className="btn btn-danger"><Link className="text-decoration-none text-dark" to='/branchadmin/branchAdminHome'>BACK</Link></button>
            </div>
        </div>
...
export default GetAllCouriersBA;