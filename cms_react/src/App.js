...
import GetAllEmps from "./pages/user/admin/GetAllEmps";
// import AddBranch from "./pages/user/admin/AddBranch";
// import AddEmployee from "./pages/user/admin/AddEmp";
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path='/branchadmin/empManagement' element={<EmployeeManagement />} />
          <Route path='branchadmin/getAllCouriers' element={<GetAllCouriersByBranch />} /> */}
          ...
          {/* <Route
            path="branchadmin/getAllCouriers"
            element={<GetAllCouriersByBranch />}
          /> */}
          ...
          <Route
            path="/customer/getAllCourier"
            element={<GetAllCustomerCouriers />}
          />

          {/* delivery boy */}
          <Route
            path="/deliveryboy/DeliveryBoyHome"
            element={<DeliveryBoyHome />}
          />
          <Route
            path="deliveryboy/getAllCouriersToBePickedUpDB"
            element={<GetAllCouriersToBePickedUpDB />}
          />
          <Route
            path="deliveryboy/GetAllCouriersToBeDeliveredDB"
            element={<GetAllCouriersToBeDeliveredDB />}
          />
        </Routes>
